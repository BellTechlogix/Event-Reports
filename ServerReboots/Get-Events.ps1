...
$OutPutSelection = MultipleSelectionBox -inputarray $outputoptions -listboxtype MultiSimple -label "Where Do You Want Your Report?:" -prompt "OutPut Selection" -sizex 280 -sizey 180
...
IF($GetSelection -eq "ManualInput")
{
       ...
       $manualselection = MultipleSelectionBox -inputarray $manualoptions -listboxtype One -label "How Do You Wish to Input Servers:" -prompt "Manual Input Mode" -sizex 280 -sizey 180
...
write-host "Following Servers Selected "$ServerSelections
